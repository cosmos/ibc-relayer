...
// PostgresIAMAuthRegion provides a mock function with no fields
func (_m *MockConfigReader) PostgresIAMAuthRegion() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PostgresIAMAuthRegion")
	}
...
// MockConfigReader_PostgresIAMAuthRegion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PostgresIAMAuthRegion'
type MockConfigReader_PostgresIAMAuthRegion_Call struct {
	*mock.Call
}

// PostgresIAMAuthRegion is a helper method to define mock.On call
func (_e *MockConfigReader_Expecter) PostgresIAMAuthRegion() *MockConfigReader_PostgresIAMAuthRegion_Call {
	return &MockConfigReader_PostgresIAMAuthRegion_Call{Call: _e.mock.On("PostgresIAMAuthRegion")}
}

func (_c *MockConfigReader_PostgresIAMAuthRegion_Call) Run(run func()) *MockConfigReader_PostgresIAMAuthRegion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockConfigReader_PostgresIAMAuthRegion_Call) Return(_a0 string) *MockConfigReader_PostgresIAMAuthRegion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockConfigReader_PostgresIAMAuthRegion_Call) RunAndReturn(run func() string) *MockConfigReader_PostgresIAMAuthRegion_Call {
	_c.Call.Return(run)
	return _c
}
